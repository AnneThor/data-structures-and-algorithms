...
Write a function named checkValues that takes in an object and a value and returns true if the value
is in the object.
...
const hasChildrenValues = (arr, character) => {
  ...
  arr.forEach((person) => {
    ...
    //if name matches zero index
    //and children array two index isnt empty
...
Write a function named totalCharacters that takes in an array and returns the number of characters
in the array.
------------------------------------------------------------------------------------------------ */
...
const houseSurvivors = (arr) => {
  ...
  arr.forEach((person) => {
    ...
    let num = Object.values(person);
    if (num[1] !== null &&
        !deceasedSpouses.includes(num[1])) {
      count ++
    }
    if (num[2] !== []) {
      count += num[2].length
    ...
    num[2].forEach((child) => {
      if (deceasedSpouses.includes(child)) {
        count--
      }
    })
    survivors.push( {
