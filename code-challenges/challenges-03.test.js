...
const sortPeople = (arr) => {
  return arr.sort((a,b) => {
    let aLower = a.lastName.toLowerCase()
    let bLower = b.lastName.toLowerCase()
    if (aLower < bLower) {
      return -1
...
const sortPeopleBetter = (arr) => {
  return arr.sort((a,b) => {
    ...
    if (lastA < lastB) {
      ...
      let firstA = a.firstName.toLowerCase()
      let firstB = b.firstName.toLowerCase()
      if (firstA < firstB) {
        return -1
...
const sortMeetingsByDay = (arr) => {
  ...
  return arr.sort((a, b) => {
    let aVal = sorter[a.dayOfWeek]
    let bVal = sorter[b.dayOfWeek]
    if (aVal > bVal) {
      return 1
    } else {
      return -1
...
const sortSchedule = (arr) => {
  ...
  return arr.sort((a, b) => {
    ...
    if (aVal > bVal) {
      ...
      let startA = parseInt(a.start)
      let startB = parseInt(b.start)
      if (startA < startB) {
        return -1
      } else if (startA > startB) {
        return 1
      } else {
        //they are the same so compare length
        let endA = parseInt(a.end)
        let endB = parseInt(b.end)
        return endA - endB
      }
    }
  })
